...
import StudentController from "./student-component/student.compoent";
import ClassController from "./class-component/class.component";
import AcademicYear from "./academicYear-component/academicYear.component";
                ...
                <div className="teacher__padding">
                    <div className="teacher__cotainer">
                        <div className="teacher__control">
                            <Paper >
                                <img className="img__logo" src="/img/NU VUONG HOA BINH.png" alt="logo" />
                                <Tabs
